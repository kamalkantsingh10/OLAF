...
4. Configuration files updated:
   - `orchestrator/config/module_i2c_addresses.yaml` created with correct module mapping (if doesn't exist)
...
- [ ] Create `modules/ears-neck/` directory
- [ ] Move any existing `modules/ears/` content to `modules/ears-neck/` (if exists)
- [ ] Create `modules/ears-neck/firmware/` subdirectory
- [ ] Create `modules/ears-neck/platformio.ini` placeholder
- [ ] Create `modules/ears-neck/README.md` documenting 7-servo unified control (ears 4× SCS0009 + neck 3× STS3215)
- [ ] Remove old `modules/neck/` directory (if exists)
- [ ] Remove old `modules/projector/` directory (if exists)
- [ ] Verify `modules/head/` exists (should already exist from Story 1.1)
- [ ] Verify `modules/body/` exists (should already exist from Story 1.1)
- [ ] Verify `modules/base/` exists (should already exist from Story 1.1)
...
- [ ] Update `/modules/` section (lines 110-164) to show 4-module structure
...
- [ ] Check if `orchestrator/config/module_i2c_addresses.yaml` exists
...
- Module directories follow pattern: `modules/<module-name>/`
...
1. **Directory Structure Verification:**
   - Use `tree modules/` or `ls -la modules/` to verify 4-module layout
...
3. **Architecture Documentation Verification:**
   - Read `docs/architecture/source-tree.md`
   - Verify `/modules/` section shows 4 modules with correct I2C addresses
   - Verify no references to old 5-module structure

4. **Configuration File Verification:**
   - Check `orchestrator/config/module_i2c_addresses.yaml` exists
...
- Created new `modules/ears-neck/` directory with firmware subdirectory
- Created comprehensive `modules/ears-neck/README.md` documenting 7-servo unified control (4× SCS0009 ears + 3× STS3215 neck)
- Created `modules/ears-neck/platformio.ini` with ESP32-S3 configuration
- Removed old `modules/ears/`, `modules/neck/`, and `modules/projector/` directories
- Verified `modules/head/`, `modules/body/`, and `modules/base/` directories exist
...
- Created `orchestrator/config/module_i2c_addresses.yaml` with complete 4-module mapping
...
**Files Created:**
- `/home/kamal/Documents/Garage/OLAF/modules/ears-neck/README.md` (180 lines)
- `/home/kamal/Documents/Garage/OLAF/modules/ears-neck/platformio.ini` (36 lines)
- `/home/kamal/Documents/Garage/OLAF/modules/ears-neck/firmware/` (directory)
- `/home/kamal/Documents/Garage/OLAF/orchestrator/config/module_i2c_addresses.yaml` (93 lines)
...
**Directories Removed:**
- `/home/kamal/Documents/Garage/OLAF/modules/ears/`
- `/home/kamal/Documents/Garage/OLAF/modules/neck/`
- `/home/kamal/Documents/Garage/OLAF/modules/projector/`
