...
| 2026-05-17 | Post-closure follow-up resolved: neck level-head zero recalibrated (`set-center`, head hand-leveled, ~0° verified) → commit `9d7e251`. Ears: no calibration needed (Kamal confirmed). |
